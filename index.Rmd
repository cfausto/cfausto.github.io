...
links:
  - label: '`r fontawesome::fa("envelope", fill = "#3FB8E0")` Email'
    url: "mailto:cfausto@usc.edu"
  - label: '`r fontawesome::fa("graduation-cap", fill = "#63D4FD")` CV'
    url: "https://bit.ly/CCF_CV_2023-07-06"
  - label: '`r fontawesome::fa("twitter", fill = "#3FB8E0")` Twitter'
    url: "https://twitter.com/connfau"
  - label: '`r fontawesome::fa("linkedin", fill = "#3FB8E0")` LinkedIn'
...
|  |  |
|:------------------------------------------------|:--------------------|
| `r fontawesome::fa("flask", fill = "#63D4FD")` **Experimental**  | `r fontawesome::fa("bar-chart", fill = "#63D4FD")` **Bioinformatic**  |
